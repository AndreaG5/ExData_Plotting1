...
plot(uci2$time, as.numeric(as.character(uci2$voltage)), type = "l", xlab = "datetime", ylab = "voltage")

plot(uci2$time, as.numeric(as.character(uci2$global_reactive_power)), type = "l", xlab = "datetime", ylab = "Global_Reactive_power")
